...
})({"dvAAo":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "6d54ec0d8b16b937";
"use strict";
...
},{}],"Zd0wj":[function(require,module,exports) {
...
},{"./login.cjs":"ase0Y","./updateProfile":"5VEyN","./tap":"gM7N6"}],"ase0Y":[function(require,module,exports) {
...
const login = async (email, password)=>{
    console.log(email, password);
    try {
        const result = await (0, _fetchData.useFetch)("http://localhost:8080/api/v1/users/login", "POST", {
            email,
            password
        });
...
const logout = async ()=>{
    try {
        const result = await (0, _fetchData.useFetch)("http://localhost:8080/api/v1/users/logout", "GET");
        /*
...
},{"./alerts.cjs":"uNYA2","./fetchData":"jiwip","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"uNYA2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"jiwip":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5VEyN":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const updateTheProfile = async (data, type)=>{
    ...
    try {
        ...
        const result = await (0, _fetchData.useFetch)(`http://localhost:8080/api/v1/users/${url}`, "PATCH", data, type);
...
},{"./alerts.cjs":"uNYA2","./fetchData":"jiwip","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gM7N6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const bookTour = async (tourId)=>{
    try {
        ...
        const session = await (0, _axiosDefault.default)(`http://127.0.0.1:8080/api/v1/bookings/checkout-session/${tourId}`);
        console.log(session);
    ...
    */ } catch (error) {
        (0, _alertsCjs.showAlerts)("error", "Sorry, something went worng, Try againg");
        console.log(error);
    }
};

},{"axios":"jo6P5","./alerts.cjs":"uNYA2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dvAAo","Zd0wj"], "Zd0wj", "parcelRequire11c7")
